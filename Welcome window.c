...
int main(){
	...
	printf("Please select your desired action: (eg. 1<ENTER>):\n");  
	...
	switch (selection){
		...
		case 4: printf("/nYou selected substitution decryption. A wizard has opened your message:\n");
